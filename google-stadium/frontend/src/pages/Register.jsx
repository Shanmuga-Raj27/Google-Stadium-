      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-900 p-6 md:p-10 rounded-3xl shadow-xl border border-gray-300 dark:border-gray-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex justify-center mt-2">
            {isLoading ? (
              <div className="flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-900 rounded-full border-2 border-dashed border-googleBlue/30 text-googleBlue font-bold text-sm animate-pulse">
